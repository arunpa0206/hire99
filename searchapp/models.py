...
class FwUsers(models.Model):
    ...
    user_email = models.CharField(verbose_name="Email", max_length=500)
    user_mobile = models.CharField(verbose_name="Mobile", max_length=500)
    ...
    user_state_name = models.CharField(max_length=500)
    ...
    user_cdate = models.DateField(verbose_name="Creation Date", blank=True, null=True)
    ...
    hq_passout_year = models.CharField(verbose_name="Passout Year", max_length=500, blank=True, null=True)
    ...
    inst_name = models.CharField(max_length=500, blank=True, null=True)
